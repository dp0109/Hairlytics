...
Hairlytics bridges AI, healthcare-inspired UI, and NLP to deliver a smart hair-care consultation experience.
It analyzes scalp and hair conditions, remembers user context, and provides intelligent recommendations through an AI-powered assistant.
...
Start the backend server:
      npm run dev
4️. AI Microservice Setup (Python)
...
Explore UI Pages like Reviews & Contact
